...
# Locate Windows SDK for stdio.h, windows.h, kernel32.lib, libcmt.lib
sdk_roots = [
...
src_files = [
    ...
    r"ss_bangladesh_nano_android_module\THSA-2B V1\src\kernels\neon_norm_act.cpp",
    r"ss_bangladesh_nano_android_module\THSA-2B V1\tests\unit\test_native_model_loader.cpp"
]

out_exe = r"ss_bangladesh_nano_android_module\THSA-2B V1\test_native_model_loader.exe"
...
print("Compiling test_native_model_loader with MSVC...")
...
if res.returncode == 0:
    print("\nExecuting test_native_model_loader.exe...")
