...
src_files = [
    ...
    r"ss_bangladesh_nano_android_module\THSA-2B V1\tests\unit\test_numerical_dataflow.cpp"
]

out_exe = r"ss_bangladesh_nano_android_module\THSA-2B V1\test_numerical_dataflow.exe"
...
print("Compiling test_numerical_dataflow with MSVC...")
...
if res.returncode == 0:
    print("\nExecuting test_numerical_dataflow.exe...")
