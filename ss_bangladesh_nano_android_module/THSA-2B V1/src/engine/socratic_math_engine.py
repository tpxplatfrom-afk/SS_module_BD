...
🌟 **পরবর্তী পদক্ষেপ (Next Step Collaboration):**
তুমি কি এই সমাধানটি বুঝতে পেরেছ? চলো এবার এর পরের অংক **২ এর (খ)** সমাধান করি, নাকি এই অধ্যায় নিয়ে অন্য কোনো প্রশ্ন আছে?"""
            },
...
লক্ষ্য করো, $(6n - 2p)$ থেকে $2$ কমন নিলে বন্ধনীর বাইরে এসে তা $2^2 = 4$ হয়ে যায়। 

🌟 **পরবর্তী পদক্ষেপ (Next Step Collaboration):**
খুব চমৎকার! তুমি কি এবার এর পরের সংখ্যাভিত্তিক অংক **২ এর (গ)** সমাধান করতে চাও?"""
            },
...
🌟 **পরবর্তী পদক্ষেপ (Next Step Collaboration):**
চলো এবার ভগ্নাংশ আকারের মজার অংক **২ এর (ঘ)** সমাধান করে ফেলি?"""
            },
...
🌟 **পরবর্তী পদক্ষেপ (Next Step Collaboration):**
অনুশীলনী ৩.১ এর সরল অংকগুলো সফলভাবে শেষ হলো! এবার কি সূত্রের সাহায্যে বর্গ নির্ণয়ের অংকগুলো (১ নং প্রশ্ন) শুরু করতে চাও?"""
            }
        }
